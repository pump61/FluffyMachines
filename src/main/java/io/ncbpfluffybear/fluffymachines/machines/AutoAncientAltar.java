...
public class AutoAncientAltar extends SlimefunItem implements EnergyNetComponent {
    ...
    public AutoAncientAltar(ItemGroup category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
        ...
        new BlockMenuPreset(getId(), "&5Altar Ancestral Automático") {
            ...
            public void newInstance(@Nonnull BlockMenu menu, @Nonnull Block b) {
                ...
                if (blockData.getData("enabled") == null || String.valueOf(false).equals(blockData.getData("enabled"))) {
                    ...
                    menu.replaceExistingItem(6, new CustomItemStack(Material.REDSTONE, "&7Ativo: &2\u2714",
                ...
                menu.replaceExistingItem(7, new CustomItemStack(Material.ENCHANTING_TABLE, "&cCraftar uma vez",
                        "", "&e> Clique para craftar uma vez")
                );
    ...
    protected void constructMenu(BlockMenuPreset preset) {
        ...
        preset.addItem(2, new CustomItemStack(new ItemStack(Material.ENCHANTING_TABLE), "&eComo usar",
                        "", "&bColoque a receita do item dentro", "&4Suporta apenas receitas do Altar Ancestral"
                ),
